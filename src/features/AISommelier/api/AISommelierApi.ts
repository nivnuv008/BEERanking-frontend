...
export type RecommendationType = 'SINGLE_BEST' | 'MULTIPLE_GOOD' | 'CLOSE_ALTERNATIVES' | 'NO_MATCH';
...
export async function askSommelier(prompt: string): Promise<AskSommelierResponse> {
  ...
  return parseJsonResponse<AskSommelierResponse>(response, 'The sommelier could not process your request');
}
